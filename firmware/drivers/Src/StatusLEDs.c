...
void Status_LEDs_Init(void) {
  ...
  HAL_GPIO_WritePin(PSOM_HB_PORT, PSOM_HB_PIN, GPIO_PIN_RESET); //|GPIO_PIN_8|GPIO_PIN_12|GPIO_PIN_15

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BRAKE_POT_LED_PORT, BRAKE_POT_LED_PIN|BRAKE_FL_LED_PIN|ACCEL_POT_LED_PIN, GPIO_PIN_RESET); //GPIO_PIN_11||GPIO_PIN_14|GPIO_PIN_15
