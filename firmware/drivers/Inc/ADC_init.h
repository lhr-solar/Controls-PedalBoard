...
extern StaticQueue_t adc1_brakeFL_front_queueBuffer;
extern QueueHandle_t adc1_brakeFL_front_RecvQ;

extern uint8_t adc1_brakeFLRed_queue[];
extern StaticQueue_t adc1_brakeFL_back_queueBuffer;
extern QueueHandle_t adc1_brakeFL_back_RecvQ;
